...
// Q2: When did you receive your last pension payment?
// --------------------
router.get('/ur-r4/kbv-no-answer/when-did-you-receive-your-last-pension-payment', (req, res) => {
    res.render('/ur-r4/kbv-no-answer/when-did-you-receive-your-last-pension-payment');
});

router.post('/ur-r4/kbv-no-answer/when-did-you-receive-your-last-pension-payment', (req, res) => {
    const day = (req.body['pension-received-day'] || '').trim();
    const month = (req.body['pension-received-month'] || '').trim();
    const year = (req.body['pension-received-year'] || '').trim();
    ...
    if (enteredDate === '25-10-2025') {
        ...
        // ❌ Incorrect date → show error page
        return res.redirect('/ur-r4/kbv-no-answer/what-is-your-mobile-telephone-number');
    }
});
...
// Q3: What is your mobile telephone number?
// --------------------
router.get('/ur-r4/kbv-no-answer/what-is-your-mobile-telephone-number', (req, res) => {
    res.render('ur-r4/kbv-no-answer/what-is-your-mobile-telephone-number');
});

router.post('/ur-r4/kbv-no-answer/what-is-your-mobile-telephone-number', (req, res) => {
    const mobileNumber = (req.body['customer-mobile-tel'] || '').trim();
